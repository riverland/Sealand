...
public class ProtoUtils {
	...
	public static List<Field> decodeRowDescMsg(Message msg) {
		...
		int pos = ProtoRowDesc.FRAG_FLD_NUM_INDEX;
		byte[] fldNumByte = ArrayUtils.subarray(data, pos, pos + ProtoRowDesc.FRAG_FLD_NUM_SIZE);

		int fldNum = NumberUtils.readInt2(fldNumByte);
		pos = +ProtoRowDesc.FRAG_FLD_NUM_SIZE;
