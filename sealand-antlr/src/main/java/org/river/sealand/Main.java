...
import java.io.*;
import org.river.sealand.TParser.a_return;
     ...
     */
    	...
    	public static void main(String[] args)
        {
            try
            {
                ...
                {
                    System.err.println("Usage: java -jar sealand-antlr-1.0-SNAPSHOT-jar-with-dependencies.jar <directory | filename.dmo>");
                }
            }
            catch (Exception ex)
            {
