...
public interface SQLCommonListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SQLCommonParser#char_literal}.
	 * @param ctx the parse tree
	 */
	void enterChar_literal(@NotNull SQLCommonParser.Char_literalContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLCommonParser#char_literal}.
	 * @param ctx the parse tree
	 */
	void exitChar_literal(@NotNull SQLCommonParser.Char_literalContext ctx);
